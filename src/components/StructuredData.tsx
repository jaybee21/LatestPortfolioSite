...
export const StructuredData: React.FC = () => {
  useEffect(() => {
    ...
    const personSchema = {
      ...
      "telephone": "+263785612696",
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "Harare",
        "addressRegion": "Greendale",
      ...
      "sameAs": [
        "https://github.com/jaybee21",
        "https://www.linkedin.com/in/jabule-simanga-56425a155/"
      ],
      "seeks": {
        "@type": "JobPosting",
    ...
    const professionalServiceSchema = {
      ...
      "name": "Jabule Simanga - Frontend Development Services",
