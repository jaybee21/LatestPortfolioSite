...
import MikeImageWebP from "../assets/Mike_192.jpg";
...
export function About() {
  ...
  return (
    <section
      id="about"
      aria-label="About Jabule Simanga"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div
            className="w-24 h-1 bg-blue-500 dark:bg-blueprint mx-auto"
            initial={{
              width: 0,
            }}
            whileInView={{
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-12 md:items-center">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <picture>
                  <source srcSet={MikeImageWebP} type="image/webp" />
                  <img
                    src={MikeImage}
          ...
          >
            ...
            <motion.div
              ...
              className="space-y-4 text-gray-600 dark:text-textSecondary leading-relaxed"
            >
              <motion.p variants={itemVariants}>
                I’m a full-stack developer with hands-on experience building and maintaining production systems used in real organisational environments.
              </motion.p>
              <motion.p variants={itemVariants}>
                My work focuses on translating complex business requirements into clean, intuitive user interfaces—while ensuring performance, security, and scalability behind the scenes. I’ve contributed to applications in education, finance, and enterprise settings, working with stakeholders to deliver systems that actually solve problems.
              </motion.p>
              <motion.p variants={itemVariants}>
                From frontend architecture in Angular and React to backend APIs and integrations, I care deeply about code quality, user experience, and building software that lasts.
              </motion.p>
              <motion.p variants={itemVariants}>
                I’m most motivated by projects that have real impact—systems people rely on every day.
              </motion.p>
            </motion.div>
            <motion.div
              variants={containerVariants}
            ...
            >
              {parallels.map((item, index) => (
                ...
                >
                  <item.icon
                    className="text-blue-600 dark:text-blueprint group-hover:text-blue-700 dark:group-hover:text-gold transition-colors mb-2"
                    size={24}
                  />
                  <div className="font-mono text-xs text-gray-700 dark:text-textSecondary">
                    {item.from} →{" "}
                    <span className="text-blue-700 dark:text-gold font-semibold">
                      {item.to}
                    </span>
                  </div>
                </motion.div>
