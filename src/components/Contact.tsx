  ...
  const socialLinks = [
    {
      icon: GithubIcon,
      label: "GitHub",
      url: "https://github.com/jaybee21",
      color: "gold",
    },
    {
      icon: LinkedinIcon,
      label: "LinkedIn",
      url: "https://www.linkedin.com/in/jabule-simanga-56425a155/",
      color: "blueprint",
    },
    {
      icon: FileText,
    ...
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="h-full bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gunmetal dark:to-blueprint/10 border-2 border-blue-200 dark:border-blueprint/30 p-8 md:p-12 flex flex-col">
              ...
              <MagneticButton
                as="a"
                href="mailto:hillarysimanga@gmail.com?subject=Let's%20Work%20Together&body=Hi%20Jabu,%0D%0A%0D%0AI'd%20like%20to%20discuss..."
                intensity={0.35}
              ...
              <div className="mt-auto pt-6 border-t border-blue-200 dark:border-blueprint/30 space-y-4">
                <div>
                  ...
                  <a
                    href="mailto:hillarysimanga@gmail.com"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-textSecondary leading-relaxed text-sm md:text-base">
                    Outside of development, I enjoy exploring how technology can improve real-world processes, whether that’s streamlining workflows or learning new tools that improve how systems scale and perform.
                  ...
                  <p className="text-gray-700 dark:text-textSecondary leading-relaxed text-sm md:text-base mt-3">
                    ...
                    I’m based in Zimbabwe and currently working on enterprise and education systems. I’m always open to opportunities where I can contribute to meaningful products, collaborate with strong teams, and continue growing as an Angular-focused engineer building reliable, user-centric applications.
                  </p>
                  ...
                  <p className="text-gray-700 dark:text-textSecondary leading-relaxed text-sm md:text-base mt-3">
                    ...
                    🟢 Open to opportunities | Full-time FullStack Developer | Frontend
      ...
      <div className="mt-20 pt-8 border-t border-blue-200 dark:border-blueprint/20 text-center">
        <p className="text-gray-600 dark:text-textSecondary text-sm font-mono">
          © 2025 Jabule Simanga. Engineered with precision.
        </p>
      </div>
    </section>
  );
